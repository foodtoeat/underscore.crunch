...
*/
(function(r,n){"function"==typeof define&&define.amd?define(["underscore"],n):"object"==typeof exports?module.exports=n(require("underscore")):n(r._)})(this,function(r){var n=r.succeed=function(n,e){n&&r.isFunction(n.success)&&n.success.apply(void 0,e)},e=r.complete=function(n,e){n&&r.isFunction(n.complete)&&n.complete.apply(void 0,e)};r.error=function(n,e){n&&r.isFunction(n.error)&&n.error.apply(void 0,e)},r.finish=function(r){e(r),n(r)},r.parallel=function(n){return function(e){if(!r.isArray(n))throw Error("Invalid structure for _.parallel");if(r.isEmpty(n))return r.finish(e);var t={success:r.after(n.length,e.success||function(){}),error:r.once(e.error||function(){}),complete:r.after(n.length,e.complete||function(){})};return r.map(n,function(r){return r(t)})}},r.serial=function(n,e){if(!r.isArray(n))throw Error("Invalid structure for _.serial");return function(t){var o=[];if(r.isEmpty(n))return r.finish(t);var i=n[0],c=r.serial(n.slice(1),e),u=r.extend({},t,{complete:r.after(2,t.complete||function(){})});return o.push(i({success:function(){r.each(c(u),function(r){o.push(r)})},error:function(){return e?r.each(c(u),function(r){o.push(r)}):r.complete(u),r.error(u,arguments)},complete:function(){r.complete(u)}})),o}};var t=r.crunch=function(n,e){return function(o){if(r.isFunction(n))return n(o);if(r.isArray(n))return r.parallel(r.map(n,function(r){return t(r,e)}))(o);if(n&&n.pre&&n.post){var i={};return r.serial([function(r){i.pre=t(n.pre,e)(r)},function(r){i.post=t(n.post,e)(r)}])(o),i}throw Error("Invalid structure for _.crunch")}};return r});